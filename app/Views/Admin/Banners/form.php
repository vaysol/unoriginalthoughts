        ...
        <div class="col-md-9">
            <form action="<?php echo base_url('/admin/banner/save') ?>/" class="was-validated1 row" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 col-md-4" hidden>
                    ...
                    <p class="admin_banner_error" id="admin_id_validate"></p>
                </div>
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <p class="admin_banner_error" id="admin_title_validate"></p>
                </div>
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <p class="admin_banner_error" id="admin_priority_validate"></p>
                </div>
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <p class="admin_banner_error" id="admin_desktop_image_validate"></p>
                </div>
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <p class="admin_banner_error" id="admin_mobile_image_validate"></p>
                </div>
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <p class="admin_user_error" id="user_status_error"></p>
                </div>
