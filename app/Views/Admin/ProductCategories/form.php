<div class="container-fluid row">
    <?php if ( isset($product_category)) 
    {
        ...
        <h2>Edit Product Category</h2> <?php 
    } 
    else 
    { ?>
        <h2> Add Product Category</h2> <?php 
    } ?>

    <div class="row">
        <div class="col-md-9">
            <form action="<?php echo base_url('/admin/product-categories/save') ?>/" class="was-validated1 row" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 col-md-4" hidden>
                    ...
                    <p class="admin_product_category_error" id="admin_product_category_id_validate"></p>
                </div>
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <p class="admin_product_category_error" id="admin_product_category_title_validate"></p>
                </div>
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <p class="admin_product_category_error" id="admin_product_category_priority_validate"></p>
                </div>
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <p class="admin_product_category_error" id="admin_product_category_desktop_image_validate"></p>
                </div>
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <p class="admin_product_category_error" id="admin_product_category_mobile_image_validate"></p>
                </div>
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <p class="admin_product_category_error" id="admin_product_category_alt_text_validate"></p>
                </div>
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <p class="admin_product_category_error" id="admin_product_category_title_text_validate"></p>
                </div>
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <p class="admin_product_category_error" id="admin_product_category_status_error"></p>
                </div>
