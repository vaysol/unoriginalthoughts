<div class="mb-3 row">
    ...
    <div class="col-md-4">
        <a href="<?php echo base_url('/admin/portfolio/add'); ?>" class="btn btn-dark float-end"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Portfolio</a>
    </div>
</div>
    ...
    <tbody>
        ...
        foreach ($portfolios as $data) {  ?>
            <tr> 
                ...
                <td>
                    <a class="text-decoration-none" href="<?php echo base_url('/admin/portfolio/edit/' . $data['id']) . '/'; ?>">
                        <i class="fa fa-pencil fa-lg mx-3" aria-hidden="true" style="color:#3a9124;"></i>
                    </a>
                    <a class="text-decoration-none" href="<?php echo base_url('/admin/portfolio/delete/' . $data['id']) . '/'; ?>" onclick="return confirm('Are you sure! You want to delete this item?')">
